...
public class Lesson01Ex01RestController {
	...
	public ResponseEntity<Data> ex01_6() {
		...
		//return new ResponseEntity<Data>(data, HttpStatus.OK); // 200 ok 성공
		return new ResponseEntity<Data>(data, HttpStatus.INTERNAL_SERVER_ERROR); // 500 INTERNAL_SERVER_ERROR
	}
}
